        ...
        <el-form
            ...
            <input id="jiaoshiId" name="jiaoshiId" type="hidden">
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.kechengVideo" label="课程视频" prop="kechengVideo">
                        <file-upload
                            tip="点击上传课程视频"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.kechengVideo" label="课程视频" prop="kechengVideo">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.kechengFile" label="课件" prop="kechengFile">
                        <file-upload
                                tip="点击上传课件"
                                action="file/upload"
                                :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.kechengFile" label="课件" prop="kechengFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="ruleForm.kechengFile"  >课件下载</a>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="科目" prop="kechengTypes">
                        <el-select v-model="ruleForm.kechengTypes" :disabled="ro.kechengTypes" placeholder="请选择科目">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="科目" prop="kechengValue">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="课程内容" prop="kechengContent">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="知识要点" prop="zhishiyaodianContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.zhishiyaodianContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.zhishiyaodianContent" label="知识要点" prop="zhishiyaodianContent">
                            <span v-html="ruleForm.zhishiyaodianContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="考试大纲" prop="kaoshidagangContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.kaoshidagangContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.kaoshidagangContent" label="考试大纲" prop="kaoshidagangContent">
                            <span v-html="ruleForm.kaoshidagangContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                ro:{
                    ...
                    zhishiyaodianContent: false,
                    kaoshidagangContent: false,
                    shangxiaTypes: false,
                    kechengDelete: false,
                },
                ruleForm: {
                ...
                rules: {
                   ...
                   kechengClicknum: [
                              { required: true, message: '课程热度不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   zhishiyaodianContent: [
                              { required: true, message: '知识要点不能为空', trigger: 'blur' },
                          ],
                   kaoshidagangContent: [
                              { required: true, message: '考试大纲不能为空', trigger: 'blur' },
                          ],
                   shangxiaTypes: [
