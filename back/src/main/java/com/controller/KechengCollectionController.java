    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(kechengCollection !=null){
            ...
            BeanUtils.copyProperties( kechengCollection , view );//把实体数据重构到view中
                ...
                //级联表
                XueshengEntity xuesheng = xueshengService.selectById(kechengCollection.getXueshengId());
                if(xuesheng != null){
    ...
    */
    ...
    public R save(@RequestBody KechengCollectionEntity kechengCollection, HttpServletRequest request){
        ...
        if(false)
            ...
            kechengCollection.setXueshengId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        Wrapper<KechengCollectionEntity> queryWrapper = new EntityWrapper<KechengCollectionEntity>()
            ...
            .eq("xuesheng_id", kechengCollection.getXueshengId())
...
//                            kechengCollectionEntity.setXueshengId(Integer.valueOf(data.get(0)));   //学生 要改的
